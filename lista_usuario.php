...
<html lang="pt-br">
	...
	<div class="box">
		...
		$max_links = 2;
		echo "<a href='lista_usuario.php?pagina=1'>Primeira</a> ";
		
		for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
			if($pag_ant >= 1){
				echo "<a href='lista_usuario.php?pagina=$pag_ant'>$pag_ant</a> ";
			}
		}
		...
		for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
			if($pag_dep <= $quantidade_pg){
				echo "<a href='lista_usuario.php?pagina=$pag_dep'>$pag_dep</a> ";
			}
		}
		
		echo "<a href='lista_usuario.php?pagina=$quantidade_pg'>Ultima</a>";
